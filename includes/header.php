      ...
      <ul class="text-uppercase d-md-flex align-items-center m-0 w-100 justify-content-end text-center text-md-left main-menu">
        ...
        <?php endif; ?>
          <li class="mr-md-5 my-md-0">
            <a href="<?php echo get_permalink($vincular_planta_a_proyecto) ? get_permalink($vincular_planta_a_proyecto) : site_url('residencial'); ?>#plantas" class="btn btn-secondary btn-sm bk--btn__primary shadow">
              Volver
            </a>
          </li>
