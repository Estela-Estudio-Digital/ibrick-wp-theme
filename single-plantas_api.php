...
<script>
  ...
  window.dataLayer.push({
    event: 'viewModel',
    projectTitle: '<?php echo get_field('nombre_planok', $id_proyecto); ?>',
...
?>
<div class="sr-only" id="eventProjectId" style="display: none;visibility: hidden;"><?php echo get_field('nombre_planok', $id_proyecto); ?></div>
