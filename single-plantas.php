                        ...
                        <?php if (have_rows('repeater_fotografias')) : ?>
                            <div class="m-3 card rounded-0">
                                <p class="pt-4 pl-3  m-0 text-left" style="font-size:1rem;">
                                    <b>
                                        <?php echo $texto_titulo; ?> <?php echo esc_html($label); ?> + <?php echo $cantidad_de_banos;
...
<?php if (have_posts()) : ?>
                ...
                <div class="col-lg-4 pt-5 mb-5">
                    <div class="plantas-info-wrap px-md-5 d-flex flex-column align-items-center">
                        <div class="wrapper w-100">
                            <h2 class="pb-5"><span class="plantas-info-title"><?php echo $texto_titulo; ?> <?php echo esc_html($label); ?> + <?php echo $cantidad_de_banos;
                                                                                                                                                echo ($cantidad_de_banos == "1") ? " Baño" : " Baños"; ?></span></h2>
                            <?php if ($unidades): ?>
    ...
    <div class="sr-only" id="eventProjectId" style="display: none;visibility: hidden;"><?php echo $proyect_title; ?></div>
    <div class="sr-only" id="eventModelId" style="display: none;visibility: hidden;"><?php echo the_title(); ?></div>
